            ...
            <form id="fcf-form-id" class="fcf-form-class" method="post">
                ...
                <div class="fcf-form-group">
                    ...
                    <div class="fcf-input-group">
                        <input type="text" id="Name" name="Name" class="fcf-form-control" required value='<?php echo $entry['unternehmensname'];?>'>
                    </div>
                </div>
                ...
                <div class="fcf-form-group">
                    ...
                    <div class="fcf-input-group">
                        <input type="text" id="Name" name="Name" class="fcf-form-control" required value='<?php echo $entry['mitarbeiteranzahl'];?>'>
                    </div>
                </div>
                ...
                <div class="fcf-form-group">
                    ...
                    <div class="fcf-input-group">
                        <input id="text" name="Message" class="fcf-form-control" rows="6" required value='<?php echo $entry['branche'];?>'></input>
                    </div>
                </div>
                ...
                <div class="fcf-form-group">
                  ...
                  <div class="fcf-input-group">
                      <input id="text" name="Message" class="fcf-form-control" rows="6" required value='<?php echo $entry['website'];?>'></input>
                  </div>
              </div>
              ...
              <div class="fcf-form-group">
                ...
                <div class="fcf-input-group">
                    <input id="text" name="Message" class="fcf-form-control" rows="6" required value='<?php echo $entry['verantwortlicher'];?>'></input>
                </div>
            </div>
