                           ...
                           <div class="row gutters">
                              ...
                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="stadt" value='<?php echo $entry['stadt'];?>'>
                                 </div>
                              </div>
                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                 <div class="form-group">
                                    <label for="softskills">Max. Gehalt</label>
                                    <input type="text" class="form-control" name="gehalt" value='<?php echo $entry['gehalt'];?>'>
                                 </div>
                              </div>
                              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                 <div class="form-group">
                                    <label for="hardskills">Wochenstunden</label>
                                    <input type="text" class="form-control" name="wochenstunden" value='<?php echo $entry['wochenstunden'];?>'>
                                 </div>
                              </div>
                           </div>
                           <div class="row gutters">
                              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                 <div class="text-right">
                                    <button class="btn btn-info mt-2" type="submit" style="background: #9c3f2a;">Suche updaten</button>
                                 </div>
                              </div>
                           </div>
                     </div>
